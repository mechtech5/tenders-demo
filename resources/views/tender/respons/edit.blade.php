						...
						<form action="{{route('tender_responsible.update',$data->id)}}" method="post">
							...
							<div class="row form-group">
								...
								<div class="col-md-4 col-lg-4 col-xl-4 mt-2">
									...
									<input class="form-control" name="mobile_no" id="" cols="30" value="{{old('mobile_no') ?? $data->mobile_no}}" rows="5">
									@error('mobile_no')
				                    <span class="text-danger" role="alert">
				                        <strong>{{ $message }}</strong>
				                    </span>
								...
								<div class="col-md-4 col-lg-4 col-xl-4 mt-2">
									...
									<input class="form-control" name="emerg_mobile" id="" cols="30" value="{{old('emerg_mobile') ?? $data->emerg_mobile}}" rows="5">
									@error('emerg_mobile')
				                    <span class="text-danger" role="alert">
							...
							<div class="row form-group">
								<div class="col-md-4 col-lg-4 col-xl-4 mt-2">
									<label for="name"><b>Designation<span class="text-danger">*</span></b> </label>
										...
										<input type="text" name="desig" class="form-control" value="{{old('desig') ?? $data->desig}}">
										@error('desig')
					                    <span class="text-danger" role="alert">
								...
								<div class="col-md-4 col-lg-4 col-xl-4 mt-2">
									...
									<input class="form-control"  value="{{old('office_loc') ?? $data->office_loc}}" name="office_loc" id="" cols="30" rows="5">
									@error('office_loc')
				                    <span class="text-danger" role="alert">
								...
								<div class="col-md-4 col-lg-4 col-xl-4 mt-2">
									...
									<input class="form-control" value="{{old('email') ?? $data->email}}" name="email" id="" cols="30" rows="5">
									@error('email')
				                    <span class="text-danger" role="alert">
				                        <strong>{{ $message }}</strong>
				                    </span>
