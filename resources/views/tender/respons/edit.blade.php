	...
	<main class="app-content">
		<div class="row">
			<div class="col-md-12 col-xl-12">
				<h1 style="font-size: 20px">Update Responsible Person</h1>
				<hr>
			</div>
		</div>
		<div class="row">
				...
				<div class="card shadow-xs">
					<div class="card-body">
						<form action="{{route('tender_responsible.update',$data->id)}}" method="post">
							...
							<div class="row">
								<div class="col-md-4 col-lg-4 col-xl-4 mt-2 offset-4">
									<label for="name"><b>Change Password</b> </label>
									<input class="form-control" name="password" id="" cols="30" rows="5">
									@error('email')
				                    <span class="text-danger" role="alert">
				                        <strong>{{ $message }}</strong>
				                    </span>
							...
							<div class="row form-group">
								<div class="slideOne col-md-4 col-lg-4 col-xl-4 mt-2 chiller_cb offset-4">
									<label for="myCheckbox">Can Login</label>	
								   <input type="checkbox" id="myCheckbox" {{$data->name == true ? 'checked':''}} name="can_login" />	    
								    <span></span>
								</div>			    																	
							</div>
