							...
							<div class="row form-group">
								<div class="col-md-6 col-lg-6 col-xl-6 mt-2 offset-3">
									...
									<div class="input-group">
										...
										<input type="text" name="account_code" class="form-control" value="{{old('account_code',$tender_type->account_code)}}" readonly>
									</div>
									@error('title')
                	...
                	@enderror
								...
								<div class="col-md-6 col-lg-6 col-xl-6 mt-2 offset-3">
									...
									<div class="input-group">
										...
										<input type="text" name="name" class="form-control" value="{{old('name',$tender_type->type_name)}}">
									</div>
									@error('title')
                    <span class="text-danger" role="alert">
                        <strong>{{ $message }}</strong>
                	...
                	@enderror
								...
								<div class="col-md-6 col-lg-6 col-xl-6 mt-2 offset-3">
									...
									<div class="input-group">
										...
										<textarea class="form-control" name="description" id="" cols="30" rows="5">{{old('description',$tender_type->type_desc)}}</textarea>
									</div>
									@error('description')
                    <span class="text-danger" role="alert">
                        <strong>{{ $message }}</strong>
