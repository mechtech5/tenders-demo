...
class PaymentsController extends Controller
{
    ...
    public function create()
    {
        ...
        $exp_in_users = ExpenseInUser::join('emp_mast','emp_mast.id','expense_in_user.emp_id')->get();

        $exp_permit_users = ExpensePermitUser::join('emp_mast','emp_mast.id','expense_permit_user.emp_id')->get();
